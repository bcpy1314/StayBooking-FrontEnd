const domain = "https://flawless-star-335000.wl.r.appspot.com";
//https://flawless-star-335000.wl.r.appspot.com
...
export const searchStays = (query) => {
  const authToken = localStorage.getItem("authToken");
  const searchStaysUrl = new URL(`${domain}/search/`); // URL is also a web api
